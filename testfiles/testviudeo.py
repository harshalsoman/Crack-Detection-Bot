...
y=[]
def video_stream():
            #'http://192.168.43.106:5000/video_feed'
...
def ml():
    new_model = load_model('C:/Users/Dell/PycharmProjects/RailwayCrack/my_h5_model_resnet50epochs.h5')
    while (True):
        global output
        ...
        y_pred = new_model.predict(pred_image)
        y.append(y_pred)
        #print(y_pred)
        if (y_pred.round() == 1):
            print("Non Defective")
